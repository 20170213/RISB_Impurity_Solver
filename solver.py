...
parser.add_argument("--half", help="halves the embedded Hamiltonian Hilbert space (warning: just leave this alone)",action='store_true')
parser.add_argument("--paramagnetic", help="seek paramagnetic solution",action='store_true')
